...
class PdfController extends Controller
{
    ...
    {
        return view('pdf.form-sertifikat');
    }
...
{
    $pdf = Pdf::loadView('pdf.sertifikat-statis')
        ->setPaper('a4', 'landscape');

    return $pdf->download('sertifikat-statis.pdf');
}

 #PDF UNDANGAN STATIS
public function undanganStatis()
{
    $pdf = Pdf::loadView('pdf.undangan-statis')
        ->setPaper('a4', 'portrait');

    return $pdf->download('undangan-statis.pdf');
}
