...
<input type="text" id="kotaInput" class="form-control" placeholder="Masukkan nama kota">
</div>

<button class="btn btn-success mb-4" id="btnTambah">
Tambahkan
</button>
...
<div class="result-value" id="hasilKota">Belum dipilih</div>
</div>
...
<button class="btn btn-success mb-4" id="btnTambah2">
Tambahkan
</button>
...
<div class="result-box">
<label>Kota Terpilih</label>
<div class="result-value" id="hasilKota2">Belum dipilih</div>
</div>
...
$("#selectKota2").append(`<option value="${kota}">${kota}</option>`).trigger('change');
