...
$('#province').change(function () {
  ...
  $('#city,#district,#village').html(function(i, _, opts) {
    const labels = ['Pilih Kota','Pilih Kecamatan','Pilih Kelurahan'];
    return `<option value="">${labels[i]}</option>`;
  });
...
$('#city').change(function () {
  ...
  $('#district,#village').html((i) => `<option value="">${['Pilih Kecamatan','Pilih Kelurahan'][i]}</option>`);
  if (!city_id) return;
